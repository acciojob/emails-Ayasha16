...
public class Email {
    ...
    public void changePassword(String oldPassword, String newPassword){
          if(oldPassword.equals(newPassword) && charchecker(newPassword) && upperchecker(newPassword) && lowerchecker(newPassword) && digitchecker(newPassword) && specialchecker(newPassword)){
